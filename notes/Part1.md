...
- [Next Step of Machine Learning (Hung-yi Lee, NTU, 2019)](https://www.youtube.com/playlist?list=PLJV_el3uVTsOK_ZK5L0Iv_EQoL1JefRL4)
- [浅谈神经机器翻译 & 用Transformer 与TensorFlow2英翻中](https://leemeng.tw/neural-machine-translation-with-transformer-and-tensorflow2.html)
...
#### Transformer
- [Positional Encoding](PositionalEncoding.md#positional-encoding)
- [Attention Visualisation](AttentionVisualisation.md)
- 